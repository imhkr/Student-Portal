...
const UserCard: FC<Props> = ({
  ...
  return (
    <div>
      <div className="w-72 ml-96 bg-gray-800 rounded-md my-2 justify-center text-white mx-auto uppercase flex flex-col transform origin-bottom-left hover:scale-75 transition duration-300 h-full">
